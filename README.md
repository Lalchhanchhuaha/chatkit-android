...
```kotlin
dependencies {
    implementation("com.github.Lalchhanchhuaha:chatkit-android:v1.6.4")
}
```

For development snapshots, replace `v1.6.4` with `main-SNAPSHOT`. Tagged versions are recommended
...
Local Maven coordinates: `com.chatkit:chatkit:1.6.4`. Minimum Android version: API 24; `java.time` is
